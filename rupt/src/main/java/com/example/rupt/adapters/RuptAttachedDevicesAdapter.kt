package com.example.rupt.adapters
...
class SabilAttachedDevicesAdapter(
    var deviceId: String,
    var devices: List<RuptDevice>,
    var selected: MutableSet<RuptDevice>
) :
    ...
    override fun onCreateViewHolder(
        ...
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.rupt_device_usage_view_holder, parent, false)
